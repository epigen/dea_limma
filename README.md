...
A [Snakemake 8](https://snakemake.readthedocs.io/en/stable/) workflow for performing and visualizing differential (expression, accessibility, binding,...) analyses of NGS data (e.g., RNA-seq, ATAC-seq, ChIP-seq, scRNA-seq,...) powered by the R package [_limma_](https://www.bioconductor.org/packages/release/bioc/html/limma.html).
...
- Differential (Expression) Analysis steps and results:
